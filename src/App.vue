        ...
        >
          ...
          <el-submenu index="3">
            ...
            <el-submenu index="3-2">
              <template slot="title">导航 3-2</template>
              <el-menu-item index="3-2-1">导航 3-2-1</el-menu-item>
              <el-menu-item index="3-2-2">导航 3-2-2</el-menu-item>
            </el-submenu>
            <el-submenu index="3-3">
              <template slot="title">导航 3-3</template>
              <el-menu-item-group>
                <template slot="title">分组一</template>
                <el-menu-item index="3-3-1">导航 3-3-1</el-menu-item>
                <el-menu-item index="3-3-2">导航 3-3-2</el-menu-item>
              </el-menu-item-group>
              <el-menu-item-group title="分组2">
                <el-menu-item index="3-3-3">导航 3-3-3</el-menu-item>
              </el-menu-item-group>
              <el-submenu index="3-3-4">
                <template slot="title">导航 3-3-4</template>
                <el-menu-item index="3-3-4-1">导航 3-3-4-1</el-menu-item>
              </el-submenu>
            </el-submenu>
          </el-submenu>
        </el-menu>
